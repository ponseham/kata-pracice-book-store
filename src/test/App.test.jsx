...
describe('Book Store', () => {
    ...
    test("Show price with discount when selecting less or equal to seven books", async () => {
        ...
        expect(screen.getByText(TEST_LESS_SEVEN__BOOK_WITH_DISCOUNT_SUBTOTAL + ' ' + TEST_CURRENCY_LABEL)).toBeInTheDocument()
        expect(screen.getByText(TEST_LESS_SEVEN__BOOK_WITH_DISCOUNT_DISCOUNT + ' ' + TEST_CURRENCY_LABEL)).toBeInTheDocument()
    });
})
